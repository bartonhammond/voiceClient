Feature: profile page
    @profile
    Scenario: Confirm downloads and delete account are working
        ...
        And I expect the text "Delete Account" to be absent
        ...
        And I expect the text "Download" to be absent
        And I expect the text "Delete Account" to be present
        #Create a Story
        ...
        And I expect the text "Delete Account" to be present
        And I tap the "profilePageDeleteAccount" button
        Then I expect the widget "profilePageDeleteAccountDialog" to be present within 5 seconds
        Given I tap the "alertDefault" button
        Then I expect the widget "profilePageDeleteAccountForSureDialog" to be present within 5 seconds
        Given I tap the "alertDefault" button
